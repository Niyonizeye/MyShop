    ...
    <div class="content-header">
      <div class="container-fluid">
        <ul class="nav nav-tabs">
            ...
            <li class="active"><a  href="{{route('ranking')}}">Ranking</a></li>
                ...
                <div class="card-body">
                  ...
                  <div class="direct-chat-messages">
                    ...
                    <div class="direct-chat-msg">
                      ...
                      <!-- /.direct-chat-infos -->
                      <img class="direct-chat-img" src="{{asset('assets/a/img/log1.png')}}" alt="message user image">
                      <!-- /.direct-chat-img -->
                  ...
                  <div class="direct-chat-contacts">
                    <ul class="contacts-list">
                      <li>
                        <a href="#">
                          <img class="contacts-list-img" src="{{asset('assets/a/img/log1.png')}}">
