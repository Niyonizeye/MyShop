    ...
    <div class="content-header">
      <div class="container-fluid">
        <ul class="nav nav-tabs">
          ...
          <li class="active"><a  href="{{route('coin_account')}}">Coin Account</a></li>
          <li><a  href="{{route('trading_account')}}">Trading Account</a></li>
              ...
              <div class="card-body">
                <div class="info-box mb-3 bg-success">
                  ...
                  <div class="info-box-content">
                    <span class="info-box-text">Coin Cash</span>
